...
/*   Updated: 2024/05/26 13:42:34 by pedromar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//void	ft_put_pixel2(t_image *img, int x, int y, int c)
//{
//	char	*dst;
//
//	x *= ( x > 0 && x < img->w);
//	y *= ( y > 0 && y < img->h && x > 0);
//	c *= (y > 0 && x > 0);
//	dst = img->addr + (y * img->size_line + x * (y > 0) * (img->bpp / 8));
//	*(unsigned int *) dst = (unsigned int)c;
//}

//static void	draw_line2(t_image *img, t_line l)
//{
//	while (l.i-- != 0)
//	{
