...
{
	printf("%f %f %f %f\n", m.elements[0][0], m.elements[1][0],
		m.elements[2][0], m.elements[3][0]);
	printf("%f %f %f %f\n", m.elements[0][1], m.elements[1][1],
		m.elements[2][1], m.elements[3][1]);
	printf("%f %f %f %f\n", m.elements[0][2], m.elements[1][2],
		m.elements[2][2], m.elements[3][2]);
	printf("%f %f %f %f\n", m.elements[0][3], m.elements[1][3],
		m.elements[2][3], m.elements[3][3]);
}
